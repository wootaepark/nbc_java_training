...
public class Main {
    public static void main(String[] args) {
        ...
        Child cc = (Child) c; // 다운캐스팅
        System.out.println(cc instanceof Object); // true
        System.out.println(cc instanceof Parent); // true
        System.out.println(cc instanceof Child); // true
